...
public class NotificationsDoctorFragment extends Fragment {

    LinearLayout containerAll;
    FirebaseFirestore db;

    public NotificationsDoctorFragment() {}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_notifications_doctor, container, false);
        containerAll = view.findViewById(R.id.containerAllNotificationsDoctor);
        db = FirebaseFirestore.getInstance();

        String doctorUid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        loadAllNotifications(doctorUid);
        ...
        db.collection("Notifications")
                ...
                .addOnSuccessListener(snapshot -> {
                    ...
                    if (snapshot.isEmpty()) {
                        ...
                        empty.setText("Δεν υπάρχουν ειδοποιήσεις ακύρωσης.");
